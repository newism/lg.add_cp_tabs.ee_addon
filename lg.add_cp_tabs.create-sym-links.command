...
echo "
You are about to create symlinks for LG Add CP Tabs
---------------------------------------------------
...
# extensions
ln -s "$dirname"/system/extensions/ext.lg_add_cp_tabs_ext.php "$ee_path"/"$ee_system_folder"/extensions/ext.lg_add_cp_tabs_ext.php

# lib
ln -s "$dirname"/system/lib/lg_add_cp_tabs "$ee_path"/"$ee_system_folder"/lib

# language
ln -s "$dirname"/system/language/english/lang.lg_add_cp_tabs_ext.php "$ee_path"/"$ee_system_folder"/language/english/lang.lg_add_cp_tabs_ext.php